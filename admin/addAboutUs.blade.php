...
@section('content')
    ...
    <table id="products-table" class="table table-hover table-bordered" style="vertical-align: middle;">
        {!! Form::model(null , ['action' => 'AdminPanelController@insertNewAboutUs', 'files'=>true, 'accept' => 'image/jpeg,image/gif,image/png,application/pdf,image/x-eps' ]) !!}
                <tr>
                    <td>
                        Sıra :
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            {!! Form::text('tittre',null, ['class' => 'form-control']) !!}
                        </div>
                    </td>
                </tr>
                <tr>
