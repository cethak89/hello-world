...
@section('content')
    ...
    <a style="margin-left: 15px;width: 143px;margin-bottom: 15px;background-color: #3c8dbc;border-color: #3c8dbc;color: white;" href="https://everybloom.com/salesByProduct" class="btn form-control">Temizle</a>
    <a style="margin-left: 2px;width: 277px;margin-bottom: 15px;" onclick="filterPage();" class="btn btn-success form-control">Sorgula</a>
    <br>
    <div style="background: white;max-width: 535px;" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <table id="products-table" class="table table-hover table-bordered" style="vertical-align: middle;max-width: 525px;font-size: 18px;">
            <tbody>
            <tr>
            ...
            @foreach( $products as $product )
                <tr>
                    ...
                    <td style="text-align: center;">
                        @if( number_format($product->saleCount / $total *100 ,1) == '0.0' )
                            {{ number_format($product->saleCount / $total *100 ,2)   }}%
                        @else
    ...
    <div style="background: white;" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <table id="products-table" class="table table-hover table-bordered" style="vertical-align: middle;max-width: 620px;font-size: 18px;">
            <tbody>
            <tr>
                <th style="width: 76px;">
                    ID
...
@section('footer')
    ...
    <script>
        ...
        function filterPage() {
            ...
            tempUrl = 'https://everybloom.com/crossSellSales?';
