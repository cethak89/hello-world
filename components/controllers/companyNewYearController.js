...
var companyNewYearModule = angular.module('companyNewYear',[
    'ui.mask',
    'ui.validate',
    'PageTagsFactoryModule'
]);

companyNewYearModule.controller('companyNewYearCtrl',function($scope,$state,$timeout,$http,analyticsHelper,PageTagsFactory,errorMessages,otherExceptions, $rootScope){
